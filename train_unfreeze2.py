...
if __name__ == "__main__":
    ...
    output_path = 'output-unfreeze2/'  # phải có / ở cuối 
    outdir = Path(output_path)

    pretrain_path = 'output-unfreeze/model_20.pt' # tiếp tục train thì nhớ thêm vào
    optimizer_path = 'output-unfreeze/optimizer_20.pt'
