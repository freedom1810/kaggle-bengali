...
if __name__ == "__main__":
    ...
    image_path = '/home/papc/sonnh/ben/data/images-fold2/' # forder alll image    # phải có / ở cuối 
    train_path = 'fold_2_train.csv' # file csv
    test_path = 'fold_2_test.csv'   # file csv
    output_path = 'output-swa/'  # phải có / ở cuối 
    outdir = Path(output_path)

    pretrain_path = 'output-unfreeze2/model_11.pt' # tiếp tục train thì nhớ thêm vào
    optimizer_path = 'output-unfreeze2/optimizer_11.pt'
    ...
    def run_evaluator(engine):
        ...
        optimizer.bn_update(train_loader, classifier.predictor, device=device)
        ModelSnapshotHandler(classifier.predictor, optimizer,  filepath = output_path)
    ...
    trainer.add_event_handler(Events.EPOCH_COMPLETED, swa)
